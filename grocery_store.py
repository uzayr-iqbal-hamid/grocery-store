...
enter_ID=Label(root,text="Enter Grocery Store Name:",fg="White",bg="Brown",font="Times")
enter_ID.place(x=600,y=300)

entry2=Entry(root, show="*")
entry2.place(x=800,y=350,height=25)
enter_ID=Label(root,text="Enter your Database Password:",fg="White",bg="Brown",font="Times")
...
def access():
    ...
    if conn.is_connected:
        ...
        def store(x,y,text,bcolor,fcolor,new):
            ...
            head=Label(f0, text =E1,fg = "black",bg = "beige", font = "Gabriola 45 bold").pack()
        ...
        def new():
            ...
            first_frame.configure(bg = "beige")
            #back button (the same thing repeated for all the buttons and frames)
            def back():
                first_frame.destroy()
            b1 = Button(first_frame,width = 21,height = 2,text = "<--",
                        ...
                        command = back)
            b1.place(x=0,y=0)
            Menu = Label(first_frame, text = "MENU",fg = "black",bg = "beige", font = "Gabriola 45 bold").pack()
            ...
            def inv():
                ...
                f1.configure(bg = "beige")
                label = Label(f1, text = "Categories",bg="beige",fg="black",font="Impact 40")
                ...
                def cook():
                    ...
                    def add():
                        ...
                        f3.configure(bg = "beige")

                       
                        entry1=Entry()
                        entry1.place(x=800,y=300,height=25)
                        enter_ID=Label(f3,text="Item Code:",fg="White",bg="Brown",font="Times")
                        enter_ID.place(x=600,y=300)

                        entry2=Entry()
                        entry2.place(x=800,y=350,height=25)
                        enter_name=Label(f3,text="Item Name:",fg="white",bg="Brown",font="Times")
                        enter_name.place(x=600,y=350)

                        entry3=Entry()
                        entry3.place(x=800,y=400,height=25)
                        enter_contact=Label(f3,text="Cost Price:",fg="white",bg="Brown",font="Times")
                        enter_contact.place(x=600,y=400)

                        entry4=Entry()
                        entry4.place(x=800,y=450,height=25)
                        enter_ledgerID=Label(f3,text="Selling Price:",fg="white",bg="Brown",font="Times")
                        enter_ledgerID.place(x=600,y=450)
                       
                        entry5=Entry()
                        entry5.place(x=830,y=500,height=25)
                        enter_ledgerID=Label(f3,text="Quantity:",fg="White",bg="Brown",font="Times")
                        enter_ledgerID.place(x=600,y=500)
                       
                        entry6=Entry()
                        entry6.place(x=830,y=550,height=25)
                        enter_ledgerID=Label(f3,text="Date of Expiry(DD-MM-YYYY)",fg="White",bg="Brown",font="Times")
                    ...
                    def view():
                        ...
                        Head=Label(f3,text="Cooking Items Available",fg="white",bg="Brown",font="Times 30")
                        Head.pack()
                        mycsr.execute("select * from inv_cook")
                        myres=mycsr.fetchall()
                        x=500
                        y=210
                        note=Label(f3,text="DATA IN THE FORM:",fg="white",bg="Brown",font="Times 20").place(x=500,y=115)
                        h=('Item Code | Item Name | Cost Price | Selling Price | Quantity | Expiry Date')
                        hl=Label(f3,text=h,fg="white",bg="Brown",font="Times 20").place(x=500,y=150)
                        for rec in myres:
                            Out=Label(f3,text=rec,fg="white",bg="Brown",font="Times 20")
                            Out.place(x=x,y=y)
                            y+=40
                ...
                def house():
                    ...
                    def view():
                        ...
                        scroll_bar=Scrollbar(f3)
                        scroll_bar.pack( side = RIGHT, fill = Y )
                        Head=Label(f3,text="Household Items Available",fg="white",bg="Brown",font="Times 30")
                        Head.pack()
                ...
                def snack():
                    ...
                    def view():
                        ...
                        scroll_bar=Scrollbar(f3)
                        scroll_bar.pack( side = RIGHT, fill = Y )
                        Head=Label(f3,text="Snacks Items Available",fg="white",bg="Brown",font="Times 30")
                        Head.pack()
                ...
                def beauty():
                    ...
                    def view():
                        ...
                        scroll_bar=Scrollbar(f3)
                        scroll_bar.pack( side = RIGHT, fill = Y )
                        Head=Label(f3,text="Beauty Items Available",fg="white",bg="Brown",font="Times 30")
                        Head.pack()
                ...
                def drink():
                    ...
                    def view():
                        ...
                        scroll_bar=Scrollbar(f3)
                        scroll_bar.pack( side = RIGHT, fill = Y )
                        Head=Label(f3,text="Drinking Items Available",fg="white",bg="Brown",font="Times 30")
                        Head.pack()
                ...
                def stationery():
                    ...
                    def view():
                        ...
                        scroll_bar=Scrollbar(f3)
                        scroll_bar.pack( side = RIGHT, fill = Y )
                        Head=Label(f3,text="Stationery Items Available",fg="white",bg="Brown",font="Times 30")
                        Head.pack()
            ...
            def details():
                ...
                def view():
                    ...
                    scroll_bar.pack( side = RIGHT, fill = Y )
                    Head=Label(f2,text="My Customers",fg="white",bg="Brown",font="Times 30")
                    Head.pack()
                    mycsr.execute("select * from cust_details")
                    myres=mycsr.fetchall()
                    x=500
                    y=210
                    note=Label(f2,text="DATA IN THE FORM:",fg="white",bg="Brown",font="Times 20").place(x=500,y=115)
                    h=('Customer ID | Customer Name | Contact No. | Ledger ID')
                    hl=Label(f2,text=h,fg="white",bg="Brown",font="Times 20").place(x=500,y=150)
                    for rec in myres:
                        Out=Label(f2,text=rec,fg="white",bg="Brown",font="Times 20")
                        Out.place(x=x,y=y)
                        y+=40
            ...
            def led():
                ...
                def l_view():
                    ...
                    scroll_bar=Scrollbar(f2)
                    scroll_bar.pack( side = RIGHT, fill = Y )
                    Head=Label(f2,text="Ledger Records",fg="white",bg="Brown",font="Times 30")
                    Head.pack()
            ...
            def details():
                ...
                def add():
                    ...
                    def calculate():
                            ...
                            ptop=Label(f3, text=a,fg='white',bg="brown",font="Times 25").place(x=500,y=350)
                            def back():
